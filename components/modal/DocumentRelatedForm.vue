    ...
    export default {
        ...
        computed: {
            ...mapState('documents', ['groups', 'task_types', 'form_loading', 'error', 'errors', 'success',
                'open_document_id', 'documentRelated', 'open_document_events', 'filter_data', 'documentDialog'
            ]),
        ...
        methods: {
            ...
            async close() {
                ...
                this.$store.commit('documents/STORE_DOCUMENT_RELATED', [])
            },
            async save() {
                const formData = new FormData();
