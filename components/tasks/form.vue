            ...
            <div v-else>
                ...
                <v-tabs-items v-model="tab" style="min-height: 595px">
                                    ...
                                    <v-col v-if="task && task.contacts">
                                        ...
                                        >
                                            ...
                                            <template v-slot:item.action="{ item }">
                                                <v-icon style="cursor:pointer" @click="openContactDialog(item.id)" v-if="isAccess">
                                                    mdi-pencil
                                                </v-icon>
                    ...
                    <v-tab-item value="tab-3">
                        <v-card-text>
                            <v-row>
                                <v-col>
                                    <v-btn color="#4e4caf" @click="openDeviceDialog(false)" dark small class="float-end" v-if="isAccess">
                                        <v-icon left>mdi mdi-plus</v-icon>
                                        устройство
                                    </v-btn>
                            ...
                            <v-row>
                                <v-col v-if="task && task.devices">
                                    ...
                                    >
                                        ...
                                        <template v-slot:item.action="{ item }">
                                            <v-icon style="cursor:pointer" @click="openDeviceDialog(item.id)" v-if="isAccess">
                                                mdi-pencil
                                            </v-icon>
                                            <v-icon style="cursor:pointer" v-if="isAccess"
                    ...
                    <v-tab-item value="tab-4">
                        <v-card-text>
                            <v-row>
                                <v-col>
                                    <v-btn color="#4e4caf" @click="openFaceDialog(false)" dark small class="float-end" v-if="isAccess">
                                        <v-icon left>mdi mdi-plus</v-icon>
                                        лицо
                            ...
                            <v-row>
                                <v-col v-if="task && task.faces">
                                    ...
                                    >
                                        ...
                                        <template v-slot:item.action="{ item }">
                                            <v-icon style="cursor:pointer" @click="openFaceDialog(item.id)" v-if="isAccess">
                                                mdi-pencil
                                            </v-icon>
                                            <v-icon style="cursor:pointer" v-if="isAccess"
                ...
                <v-card tile>
                    ...
                    <v-card-actions>
                        ...
                        <v-spacer></v-spacer>
                        <v-btn
                                v-if="task && task.status_id === 1 && isAccess"
                                color="red darken-2"
                                text
                                @click="setStatus(2)"
                        >
                        ...
                        <v-btn
                                v-if="task && task.status_id === 2 && isAccess"
                                color="red darken-2"
                                text
                                @click="setStatus(3)"
                        >
    ...
    export default {
        ...
        methods: {
            ...
            async close() {
                ...
                await this.$store.dispatch('tasks/GET_TASKS_FROM_API', [this.filter_data, 0, 1]);
            },
            async save() {
